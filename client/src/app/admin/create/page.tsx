        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8">
            <div className="flex items-center justify-center gap-3 mb-4">
              ...
              <h1 className="text-4xl font-bold bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">Add New Book</h1>
            </div>
            <p className="text-muted-foreground text-lg">Fill in the details below to add a new book to your collection</p>
          </div>
            ...
            <CardContent className="px-8 pb-8">
              <form onSubmit={handleSubmit} className="space-y-8" encType="multipart/form-data">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                  ...
                  <div className="space-y-6">
                    <div className="space-y-2">
                      ...
                      <Input id="title" type="text" placeholder="Enter book title" value={bookData.title} onChange={(e) => handleInputChange("title", e.target.value)} className="h-12 border-2 focus:border-primary transition-all duration-200 bg-background/50" required />
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <div
                        className={cn("border-2 border-dashed rounded-xl p-8 text-center transition-all duration-300 bg-gradient-to-br from-muted/30 to-background", dragActive ? "border-accent bg-accent/10 scale-105" : "border-border hover:border-accent/50 hover:bg-accent/5")}
                      ...
                      >
                        {imagePreview ? (
                          <div className="relative">
                            <img src={imagePreview || "/placeholder.svg"} alt="Cover preview" className="mx-auto max-h-48 rounded-lg object-cover shadow-lg" />
                            <Button
                              type="button"
                              variant="destructive"
                              size="sm"
                          ...
                          <div>
                            ...
                            <p className="text-sm text-muted-foreground mb-4 font-medium">Drag and drop an image here, or click to select</p>
                            <input
                              type="file"
                              accept="image/*"
                              onChange={(e) => {
                              ...
                              id="cover-upload"
                            />
                            <Button type="button" variant="outline" className="border-2 hover:border-primary hover:bg-primary/5 bg-transparent" onClick={() => document.getElementById("cover-upload")?.click()}>
                              Select Image
                            </Button>
                          </div>
                        )}
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input id="publishedDate" type="date" value={bookData.publishedDate} onChange={(e) => handleInputChange("publishedDate", e.target.value)} className="h-12 border-2 focus:border-primary transition-all duration-200 bg-background/50" />
                    </div>
                    ...
                    <div className="relative space-y-2">
                      ...
                      <div className="relative" onClick={() => setIsGenreDropdownOpen(!isGenreDropdownOpen)}>
                        <div className="min-h-[48px] w-full rounded-lg border-2 border-border bg-background/50 px-4 py-3 text-sm ring-offset-background cursor-pointer flex items-center justify-between hover:border-primary/50 transition-all duration-200">
                          ...
                          <ChevronDown className={cn("h-5 w-5 transition-transform duration-200 text-primary", isGenreDropdownOpen && "rotate-180")} />
                        </div>
                ...
                <div className="flex gap-4 pt-6">
                  ...
                  <Button type="button" variant="outline" className="flex-1 h-12 border-2 hover:border-primary hover:bg-primary/5 font-semibold transition-all duration-200 bg-transparent">
                    Cancel
                  </Button>
                </div>
              </form>
